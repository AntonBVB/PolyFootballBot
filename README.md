...
Live mode requires a valid funded wallet configuration.
...
In live mode the bot validates credentials at startup and preserves exchange payloads for orders in sqlite.
